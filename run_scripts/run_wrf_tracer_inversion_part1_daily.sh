...
# Run analysis
    ...
    # Join WRF files
    cd $joiner_path
    eval "./submit_runjoiner_reserve.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep_tracer} 1 '${WRF_TRACER_OUT_week}' '${WRF_TRACER_OUT_week}' 'tracer'"
    eval "./submit_runjoiner_reserve.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep_nofire} 1 '${WRF_NOFIRE_OUT_week}' '${WRF_NOFIRE_OUT_week}' 'nofire'"
    ...
    cd $joiner_path
    eval "./erase_wrfout_tile_files_reserve.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep_tracer} 1 '${WRF_TRACER_OUT_week}' '${WRF_TRACER_OUT_week}' 'tracer' "
    eval "./erase_wrfout_tile_files_reserve.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep_nofire} 1 '${WRF_NOFIRE_OUT_week}' '${WRF_NOFIRE_OUT_week}' 'nofire' "

    # change permission 
    chmod a+rx ${WRF_NOFIRE_OUT_week}
    chmod a+r ${WRF_NOFIRE_OUT_week}/* 
    chmod a+rx ${WRF_TRACER_OUT_week}
    chmod a+r ${WRF_TRACER_OUT_week}/* 
