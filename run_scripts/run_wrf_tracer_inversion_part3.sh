...
timestep_nofire_rst=$[$timestep-$timestep_nofire]
    ...
    # Join WRF files
    eval "./submit_runjoiner_fn.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep} 1 '${WRF_ANALYSIS_DIR}' '${WRF_ANALYSIS_OUT_week}' 'analy'"
    ...
    eval "./erase_wrfout_tile_files.sh ${year_i} ${month_i} ${day_i} ${hour_i} ${timestep} 1 '${WRF_ANALYSIS_DIR}' '${WRF_ANALYSIS_OUT_week}' 'analy'"
